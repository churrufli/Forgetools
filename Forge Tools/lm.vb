...
Public Class lm
    ...
    Private Sub lm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        'busco el modo en el que launchmode
    ...
    Private Sub lm_Closed(sender As Object, e As EventArgs) Handles Me.Closed
        ...
        If rbt_advancedmode.Checked And tb_launchline.Text = "" Then
            ...
            Exit Sub
        End If
        'COMPRUEBO SI ALGO CAMBIÓ, GUARDO LAS OPCIONES Y REINICIO SI HA CAMBIADO

        'si es distinto el modo al que tiene, o la linea de lanzar cambió, hay cambios
        Dim modoseleccionado
        If rbt_advancedmode.Checked Then
            modoseleccionado = "advanced"
        Else
            modoseleccionado = "normal"

        End If

        If modoseleccionado <> fn.ReadLogUser("launchmode") Then
            haschanges = True
        End If
