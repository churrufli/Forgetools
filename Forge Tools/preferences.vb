Public Class preferences
    Private Sub preferences_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If fn.ReadLogUser("delcardordeck", False) = "yes" Then
            chk_delcardordeck.Checked = True
        Else
            chk_delcardordeck.Checked = False
        End If

        If fn.ReadLogUser("checklauncherupdates", False) = "yes" Then
            checklauncherupdates.Checked = True
        Else
